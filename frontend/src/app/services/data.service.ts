...
import { CourseBluepint, CourseOffering, CourseOfferingNested, Faculty, StudyProgram, StudyProgramInstance } from '../models/Data.models';
...
export class DataService {
  ...
  public postCourseOfferings(data: any) {
    return this.http.post<CourseOffering>(`${this.APIURL}/course_offerings`, data);
  }
}
